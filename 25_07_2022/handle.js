...
let compare = () => {
  let firstDropdown = document.getElementById("firstDogList");
  let firstSelection = firstDropdown.options[firstDropdown.selectedIndex].value;

  console.log(`Selected indexed ${firstDropdown.selectedIndex}`);

  let secondDropdown = document.getElementById("secondDogList");
  let secondSelection =
    secondDropdown.options[secondDropdown.selectedIndex].value;
